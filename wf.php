...
<section class="about" id="about">
    ...
    <h1 class="heading"> <span> Water and Food  </span> Dispenser</h1>
    ...
    <div class="row">
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <div class="image">
                    <img style="display:flex; justify-content: center;"   src="images/WaterFood.jpg" alt="">
                    ...
                    <div class="icons">
                        ...
                        <a href="#" class="cart-btn">Add to Cart</a>
                        <a href="#" class="cart-btn">Preview</a>
                    </div>
                </div>
                <div class="content">
                    <h3>Water and Food Dispenser</h3>
